...
{
    /*public class TenantEnabledUserManager<TUser> : IDisposable where TUser : class
    {
        ...
        public TenantEnabledUserManager(IUserStore<TUser> store,
            ...
            ILogger<TenantEnabledUserManager<TUser>> logger)
        {
            if (store == null)
            {
